...
export const mbtiDescriptions: Record<string, { title: string; keywords: string }> = {
  INTJ: { title: "建築家", keywords: "戦略的・独立心・完璧主義・ビジョン" },
  INTP: { title: "論理学者", keywords: "知的好奇心・分析的・理論・革新" },
  ENTJ: { title: "指揮官", keywords: "リーダーシップ・決断力・野心・効率" },
  ENTP: { title: "討論者", keywords: "アイデア・挑戦・機知・可能性" },
  INFJ: { title: "提唱者", keywords: "直感・共感・理想主義・洞察力" },
  INFP: { title: "仲介者", keywords: "詩的・共感・誠実・夢想家" },
  ENFJ: { title: "主人公", keywords: "カリスマ・共感・インスピレーション・導く" },
  ENFP: { title: "広報運動家", keywords: "自由・創造・情熱・可能性" },
  ISTJ: { title: "管理者", keywords: "責任感・誠実・伝統・信頼性" },
  ISFJ: { title: "擁護者", keywords: "温かみ・献身・実直・思いやり" },
  ESTJ: { title: "幹部", keywords: "秩序・規律・実行力・誠実" },
  ESFJ: { title: "領事官", keywords: "調和・サポート・社交性・思いやり" },
  ISTP: { title: "巨匠", keywords: "実践的・冷静・観察力・技術" },
  ISFP: { title: "冒険家", keywords: "感性・自由・芸術・今この瞬間" },
  ESTP: { title: "起業家", keywords: "行動力・エネルギッシュ・現実主義・刺激" },
  ESFP: { title: "エンターテイナー", keywords: "陽気・自発性・美的センス・喜び" },
};
